    ...
    <div if="{ ready }">
        ...
        <div class="uk-margin uk-clearfix" if="{ App.Utils.count(forms) }">
            ...
            <div class="uk-float-right">
                ...
                <a class="uk-button uk-button-large uk-button-primary uk-width-1-1" href="<?php $app->route('/forms/form'); ?>"><i class="uk-icon-plus-circle uk-icon-justify"></i>  <?php echo $app("i18n")->get('Form'); ?></a>
        ...
        <div class="uk-width-medium-1-1 uk-viewport-height-1-3 uk-container-center uk-text-center uk-flex uk-flex-middle uk-flex-center" if="{ !App.Utils.count(forms) }">
            ...
            <div class="uk-width-medium-1-4 uk-animation-scale">
                ...
                <p>
                    <img src="<?php echo $app->pathToUrl('forms:icon.svg'); ?>" width="80" height="80" alt="Forms" data-uk-svg />
                </p>
                <hr>
                <span class="uk-text-large uk-text-muted"><?php echo $app("i18n")->get('No forms'); ?>. <a href="<?php $app->route('/forms/form'); ?>">Create a form.</a></span>
