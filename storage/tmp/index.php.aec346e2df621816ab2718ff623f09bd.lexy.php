    ...
    <div if="{ ready }">
        ...
        <div class="uk-margin uk-clearfix" if="{ App.Utils.count(regions) }">
            ...
            <div class="uk-float-right">
                <a class="uk-button uk-button-large uk-button-primary uk-width-1-1" href="<?php $app->route('/regions/region'); ?>"><i class="uk-icon-plus-circle uk-icon-justify"></i>  <?php echo $app("i18n")->get('Region'); ?></a>
            </div>
            <?php } ?>
        ...
        <div class="uk-width-medium-1-1 uk-viewport-height-1-3 uk-container-center uk-text-center uk-flex uk-flex-middle uk-flex-center" if="{ !App.Utils.count(regions) }">
            ...
            <div class="uk-width-medium-1-3 uk-animation-scale">
                ...
                <p>
                    <img src="<?php echo $app->pathToUrl('regions:icon.svg'); ?>" width="80" height="80" alt="Regions" data-uk-svg />
                </p>
                <hr>
                <span class="uk-text-large uk-text-muted"><?php echo $app("i18n")->get('No regions'); ?>.

                <?php if ($app->module("cockpit")->hasaccess('regions', 'create')) { ?>
                <a href="<?php $app->route('/regions/region'); ?>">Create a region.</a></span>
                <?php } ?>
