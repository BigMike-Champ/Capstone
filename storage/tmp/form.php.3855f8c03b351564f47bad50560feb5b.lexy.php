    ...
    <form class="uk-form" onsubmit="{ submit }">
        ...
        <div class="uk-grid">
            ...
            <div class="uk-width-medium-1-2">
                ...
                <div class="uk-margin">
                    <field-boolean bind="form.in_menu" label="<?php echo $app("i18n")->get('Show in system menu'); ?>"></field-boolean>
                </div>
        ...
        <div class="uk-margin-large-top">
            ...
            <button class="uk-button uk-button-large uk-button-primary uk-margin-right"><?php echo $app("i18n")->get('Save'); ?></button>

            <a href="<?php $app->route('/forms'); ?>">
