            ...
            <div class="uk-width-medium-1-4">
               <div class="uk-panel uk-panel-box uk-panel-card">
                   ...
                   <div class="uk-margin">
                    ...
                    <div class="uk-margin">
                        <field-boolean bind="collection.sortable" title="<?php echo $app("i18n")->get('Sortable entries'); ?>" label="<?php echo $app("i18n")->get('Sortable entries'); ?>"></field-boolean>
                    </div>
            ...
            <div class="uk-width-medium-3-4">
                ...
                <div class="uk-margin-large-top" show="{ collection.fields.length }">
                    ...
                    <div class="uk-button-group uk-margin-right">
                        ...
                        <a class="uk-button uk-button-large" href="<?php $app->route('/collections/entries'); ?>/{ collection.name }" if="{ collection._id }"><i class="uk-icon-list"></i> <?php echo $app("i18n")->get('Show entries'); ?></a>
                    </div>

                    <a href="<?php $app->route('/collections'); ?>">
