                ...
                <div class="uk-form-row">
                    ...
                    <div class="uk-margin-large-top">
                        ...
                        <div class="uk-button-group uk-margin-right">
                            ...
                            <a class="uk-button uk-button-large" href="<?php $app->route('/regions/form'); ?>/{ region.name }" if="{ region._id }"><i class="uk-icon-eye"></i> <?php echo $app("i18n")->get('Show form'); ?></a>
                        </div>

                        <a href="<?php $app->route('/regions'); ?>">
